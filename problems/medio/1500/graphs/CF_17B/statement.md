...
- Codeforces: [17B](https://codeforces.com/problemset/problem/17/B)
- Score/rating: 1500
- Categoria local: `graphs`
- Tags Codeforces: dfs and similar, dsu, greedy, shortest paths
- Resolvidos no Codeforces: 6757
- Titulo original: B. Hierarchy

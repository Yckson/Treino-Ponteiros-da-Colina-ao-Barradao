# CF_2257F1 — Beaver's Jumping Track (Easy Version)

- Codeforces: [2257F1](https://codeforces.com/contest/2257/problem/F1)
- Score/rating: unrated
- Categoria local: `implementation`
- Tags Codeforces: sem tags
- Resolvidos no Codeforces: 0
- Titulo original: F1. Beaver's Jumping Track (Easy Version)
...
This is the easy version of the problem. The difference between the versions is that in this version, the constraint on `x` and time limit are lower. You can hack only if you solved all versions of this problem.
...
The first line contains three integers `n`, `q`, `x` — the number of sections of the track, the number of queries, and the maximum jump length, respectively (`1 <= n <= 10^6`; `1 <= q <= 10^4`; `1 <= x <= 5`).
